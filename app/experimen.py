...
class BerandaFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        data = {
            "no": 1,
            "judul": "Pembangunan Gedung DPR",
            "deskripsi": "Tempat koruptor",
            "prioritas": 10
        }
        self.data = [data for i in range(5)]
        ...
        self.body_frame = [ctk.CTkFrame(self.body_parent) for i in range(5)]
